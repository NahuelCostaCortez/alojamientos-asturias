...
import es.uniovi.Alojamientos.Presentacion.Activities.AlberguesFilters;
 ...
 */
public class albergues_fragment extends Fragment {

    private static final String ALBERGUES_LIST_FILENAME = "LIST_ALBERGUES";
    private static final String PREFERENCES = "PREFERENCES";
    static SharedPreferences prefs;
    private SharedPreferences.Editor prefsEditor;
    private ArrayList<Alojamiento> albergues_list;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private DatosAlberguesViewModel alberguesViewModel;
    private albergues_fragment.Callbacks mCallback;
    ...
    public void onAttach(Context context) {
        ...
        if (activity != null) {
            mCallback = (albergues_fragment.Callbacks) activity;
        }
        else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.albergues_fragment, container, false);
        getActivity().setTitle(R.string.shelters);
        ...
        mRecyclerView = view.findViewById(R.id.recycler_view_albergues);
        ...
        mAdapter = new myAdapter(noAlojamientos, getContext(), R.layout.recycler_view_item, "ALBERGUES", new myAdapter.OnItemClickListener() {
            @Override
        ...
        alberguesViewModel = ViewModelProviders.of(this).get(DatosAlberguesViewModel.class);
        albergues_list = (ArrayList<Alojamiento>) alberguesViewModel.getAlberguesList();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String current_order_by = prefs.getString("CURRENT_ORDER_BY","");
            if(!current_order_by.equals("")){
                switch (current_order_by) {
                    case "ALFABETICAMENTE":
                        albergues_list.sort(new Comparator<Alojamiento>() {
                            @Override
        ...
        ((myAdapter) mAdapter).setAlojamientos(albergues_list);

        alberguesViewModel.getAppStatus().observe(this, new Observer<MainActivity.AppStatus>() {
            @Override
        ...
        if(savedInstanceState != null){
            //albergues_list = savedInstanceState.getParcelableArrayList(ALBERGUES_LIST_FILENAME);
            //((myAdapter) mAdapter).setAlojamientos(albergues_list);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        //outState.putParcelableArrayList(ALBERGUES_LIST_FILENAME,albergues_list);
    ...
    private void item_details(Alojamiento alojamiento) {
        ...
        mCallback.onAlbergueSelected(alojamiento);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.options_filters:
                Intent intent = new Intent(getActivity(), AlberguesFilters.class);
