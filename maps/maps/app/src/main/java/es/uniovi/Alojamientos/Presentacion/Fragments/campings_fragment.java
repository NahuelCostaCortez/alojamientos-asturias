...
import es.uniovi.Alojamientos.Presentacion.Activities.CampingFilters;
 ...
 */
public class campings_fragment extends Fragment {

    private static final String CAMPING_LIST_FILENAME = "LIST_CAMPINGS";
    private static final String PREFERENCES = "PREFERENCES";
    static SharedPreferences prefs;
    private SharedPreferences.Editor prefsEditor;
    private ArrayList<Alojamiento> campings_list;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private DatosCampingsViewModel campingsViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.campings_fragment, container, false);
        getActivity().setTitle(R.string.campings);
        ...
        mRecyclerView = view.findViewById(R.id.recycler_view_campings);
        ...
        mAdapter = new myAdapter(noAlojamientos, getContext(), R.layout.recycler_view_item, "CAMPINGS", new myAdapter.OnItemClickListener() {
            @Override
        ...
        campingsViewModel = ViewModelProviders.of(this).get(DatosCampingsViewModel.class);
        campings_list = (ArrayList<Alojamiento>) campingsViewModel.getCampingsList();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String current_order_by = prefs.getString("CURRENT_ORDER_BY","");
            if(!current_order_by.equals("")){
                switch (current_order_by) {
                    case "ALFABETICAMENTE":
                        campings_list.sort(new Comparator<Alojamiento>() {
                            @Override
        ...
        ((myAdapter) mAdapter).setAlojamientos(campings_list);


        campingsViewModel.getAppStatus().observe(this, new Observer<MainActivity.AppStatus>() {
            @Override
        ...
        if(savedInstanceState != null){
            campings_list = savedInstanceState.getParcelableArrayList(CAMPING_LIST_FILENAME);
            ((myAdapter) mAdapter).setAlojamientos(campings_list);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(CAMPING_LIST_FILENAME,campings_list);
    ...
    private void item_details(Alojamiento alojamiento) {
        ...
        mCallback.onCampingSelected(alojamiento);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.options_filters:
                Intent intent = new Intent(getActivity(), CampingFilters.class);
