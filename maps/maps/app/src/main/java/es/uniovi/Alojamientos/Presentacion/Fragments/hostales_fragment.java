...
import es.uniovi.Alojamientos.Presentacion.Activities.HostalesFilters;
 ...
 */
public class hostales_fragment extends Fragment {

    private static final String HOSTALES_LIST_FILENAME = "LIST_HOSTALES";
    private static final String PREFERENCES = "PREFERENCES";
    static SharedPreferences prefs;
    private SharedPreferences.Editor prefsEditor;
    private ArrayList<Alojamiento> hostales_list;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private DatosHostalesViewModel hostalesViewModel;
    private hostales_fragment.Callbacks mCallback;
    ...
    public void onAttach(Context context) {
        ...
        if (activity != null) {
            mCallback = (hostales_fragment.Callbacks) activity;
        }
        else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.hostales_fragment, container, false);
        getActivity().setTitle(R.string.hostels);
        ...
        mRecyclerView = view.findViewById(R.id.recycler_view_hostales);
        ...
        mAdapter = new myAdapter(noAlojamientos, getContext(), R.layout.recycler_view_item, "HOSTALES", new myAdapter.OnItemClickListener() {
            @Override
        ...
        hostalesViewModel = ViewModelProviders.of(this).get(DatosHostalesViewModel.class);
        hostales_list = (ArrayList<Alojamiento>) hostalesViewModel.getHostalesList();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String current_order_by = prefs.getString("CURRENT_ORDER_BY","");
            if(!current_order_by.equals("")){
                switch (current_order_by) {
                    case "ALFABETICAMENTE":
                        hostales_list.sort(new Comparator<Alojamiento>() {
                            @Override
        ...
        ((myAdapter) mAdapter).setAlojamientos(hostales_list);


        hostalesViewModel.getAppStatus().observe(this, new Observer<MainActivity.AppStatus>() {
            @Override
        ...
        if(savedInstanceState != null){
            //hostales_list = savedInstanceState.getParcelableArrayList(HOSTALES_LIST_FILENAME);
            //((myAdapter) mAdapter).setAlojamientos(hostales_list);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        //outState.putParcelableArrayList(HOSTALES_LIST_FILENAME,hostales_list);
    ...
    private void item_details(Alojamiento alojamiento) {
        ...
        mCallback.onHostalSelected(alojamiento);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.options_filters:
                Intent intent = new Intent(getActivity(), HostalesFilters.class);
