...
import es.uniovi.Alojamientos.Presentacion.Activities.ApartamentosFilters;
 ...
 */
public class apartamentos_fragment extends Fragment {


    private static final String APARTAMENTOS_LIST_FILENAME = "LIST_APARTAMENTOS";
    private static final String PREFERENCES = "PREFERENCES";
    static SharedPreferences prefs;
    private SharedPreferences.Editor prefsEditor;
    private ArrayList<Alojamiento> apartamentos_list;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private DatosApartamentosViewModel apartamentosViewModel;
    private apartamentos_fragment.Callbacks mCallback;
    ...
    public void onAttach(Context context) {
        ...
        if (activity != null) {
            mCallback = (apartamentos_fragment.Callbacks) activity;
        }
        else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.apartamentos_fragment, container, false);
        getActivity().setTitle(R.string.apartments);
        ...
        mRecyclerView = view.findViewById(R.id.recycler_view_apartamentos);
        ...
        mAdapter = new myAdapter(noAlojamientos, getContext(), R.layout.recycler_view_item, "APARTAMENTOS", new myAdapter.OnItemClickListener() {
            @Override
        ...
        apartamentosViewModel = ViewModelProviders.of(this).get(DatosApartamentosViewModel.class);
        apartamentos_list = (ArrayList<Alojamiento>) apartamentosViewModel.getApartamentosList();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String current_order_by = prefs.getString("CURRENT_ORDER_BY","");
            if(!current_order_by.equals("")){
                switch (current_order_by) {
                    case "ALFABETICAMENTE":
                        apartamentos_list.sort(new Comparator<Alojamiento>() {
                            @Override
        ...
        ((myAdapter) mAdapter).setAlojamientos(apartamentos_list);


        apartamentosViewModel.getAppStatus().observe(this, new Observer<MainActivity.AppStatus>() {
            @Override
        ...
        if(savedInstanceState != null){
            //apartamentos_list = savedInstanceState.getParcelableArrayList(APARTAMENTOS_LIST_FILENAME);
            //((myAdapter) mAdapter).setAlojamientos(apartamentos_list);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        //outState.putParcelableArrayList(APARTAMENTOS_LIST_FILENAME, apartamentos_list);
    ...
    private void item_details(Alojamiento alojamiento) {
        ...
        mCallback.onApartamentosSelected(alojamiento);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.options_filters:
                Intent intent = new Intent(getActivity(), ApartamentosFilters.class);
