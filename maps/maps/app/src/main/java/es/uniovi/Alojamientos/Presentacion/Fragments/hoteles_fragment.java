...
import es.uniovi.Alojamientos.Presentacion.Activities.HotelesFilters;
 ...
 */
public class hoteles_fragment extends Fragment {


    private static final String HOTELES_LIST_FILENAME = "LIST_HOTELS";
    private static final String PREFERENCES = "PREFERENCES";
    static SharedPreferences prefs;
    private SharedPreferences.Editor prefsEditor;
    private ArrayList<Alojamiento> hoteles_list;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private DatosHotelesViewModel hotelesViewModel;
    private hoteles_fragment.Callbacks mCallback;
    ...
    public void onAttach(Context context) {
        ...
        if (activity != null) {
            mCallback = (hoteles_fragment.Callbacks) activity;
        }
        else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.hoteles_fragment, container, false);
        ...
        mRecyclerView = view.findViewById(R.id.recycler_view_hoteles);
        ...
        mAdapter = new myAdapter(noAlojamientos, getContext(), R.layout.recycler_view_item, "HOTELES", new myAdapter.OnItemClickListener() {
            @Override
        ...
        hotelesViewModel = ViewModelProviders.of(this).get(DatosHotelesViewModel.class);
        hoteles_list = (ArrayList<Alojamiento>) hotelesViewModel.getHotelesList();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String current_order_by = prefs.getString("CURRENT_ORDER_BY","");
            if(!current_order_by.equals("")){
                switch (current_order_by) {
                    case "ALFABETICAMENTE":
                        hoteles_list.sort(new Comparator<Alojamiento>() {
                            @Override
        ...
        ((myAdapter) mAdapter).setAlojamientos(hoteles_list);


        hotelesViewModel.getAppStatus().observe(this, new Observer<MainActivity.AppStatus>() {
            @Override
        ...
        if(savedInstanceState != null){
            //hoteles_list = savedInstanceState.getParcelableArrayList(HOTELES_LIST_FILENAME);
            //((myAdapter) mAdapter).setAlojamientos(hoteles_list);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        //outState.putParcelableArrayList(HOTELES_LIST_FILENAME, hoteles_list);
    ...
    private void item_details(Alojamiento alojamiento) {
        ...
        mCallback.onHotelesSelected(alojamiento);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.options_filters:
                Intent intent = new Intent(getActivity(), HotelesFilters.class);
